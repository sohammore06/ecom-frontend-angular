...
import { FollowInstagramCardComponent } from "../../../Component/follow-instagram-card/follow-instagram-card.component";
...
@Component({
    selector: 'app-home-fashion9',
    imports: [RouterLink, CommonModule, LatestBlogComponent, CommonModule, FollowInstagramCardComponent, FooterComponent, PopupComponent, CardModelComponent, HeaderFashion09Component, TopBannerComponent],
    templateUrl: './home-fashion9.component.html',
    styleUrl: './home-fashion9.component.scss'
})
export class HomeFashion9Component {
  products = [
    {
