...
@Component({
    selector: 'app-shop',
    imports: [RouterLink, CommonModule, CommonModule, TopBannerComponent, RouterLink, CommonModule, CommonModule, FooterComponent, PopupComponent, HeaderComponent, CardModelComponent],
