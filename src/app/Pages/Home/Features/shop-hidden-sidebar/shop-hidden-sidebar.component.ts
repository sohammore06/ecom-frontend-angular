...
@Component({
    selector: 'app-shop-hidden-sidebar',
    imports: [RouterLink, CommonModule, TopBannerComponent, CommonModule, RouterLink, CommonModule, HeaderComponent, FooterComponent, PopupComponent, CardModelComponent],
    templateUrl: './shop-hidden-sidebar.component.html',
    styleUrl: './shop-hidden-sidebar.component.scss'
})
export class ShopHiddenSidebarComponent {
