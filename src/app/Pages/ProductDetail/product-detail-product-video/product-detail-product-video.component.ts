...
@Component({
    selector: 'app-product-detail-product-video',
    imports: [RouterLink, CommonModule, ProductModalsComponent, ProductLikeCardComponent, FooterComponent, ProductRecentlyCardComponent, PopupComponent, CardModelComponent, TopBannerComponent, HeaderComponent],
    templateUrl: './product-detail-product-video.component.html',
    styleUrl: './product-detail-product-video.component.scss'
})
export class ProductDetailProductVideoComponent {
