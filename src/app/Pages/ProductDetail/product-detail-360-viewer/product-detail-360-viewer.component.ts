...
@Component({
    selector: 'app-product-detail-360-viewer',
    imports: [RouterLink, CommonModule, ProductModalsComponent, CardModelComponent, ProductLikeCardComponent, ProductRecentlyCardComponent, PopupComponent, FooterComponent, TopBannerComponent, HeaderComponent],
    templateUrl: './product-detail-360-viewer.component.html',
    styleUrl: './product-detail-360-viewer.component.scss'
})
export class ProductDetail360ViewerComponent {
