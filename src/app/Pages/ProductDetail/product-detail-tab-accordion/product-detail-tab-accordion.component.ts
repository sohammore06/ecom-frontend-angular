...
@Component({
    selector: 'app-product-detail-tab-accordion',
    ...
    templateUrl: './product-detail-tab-accordion.component.html',
    styleUrl: './product-detail-tab-accordion.component.scss'
})
export class ProductDetailTabAccordionComponent {
