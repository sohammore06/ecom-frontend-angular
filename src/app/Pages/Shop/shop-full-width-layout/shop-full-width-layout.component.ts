...
@Component({
    selector: 'app-shop-full-width-layout',
    imports: [RouterLink, CommonModule, TopBannerComponent, CommonModule, RouterLink, CommonModule, HeaderComponent, CardModelComponent, PopupComponent, FooterComponent],
    templateUrl: './shop-full-width-layout.component.html',
    styleUrl: './shop-full-width-layout.component.scss'
})
export class ShopFullWidthLayoutComponent {
