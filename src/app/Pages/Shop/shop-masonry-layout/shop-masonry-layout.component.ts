...
@Component({
    selector: 'app-shop-masonry-layout',
    imports: [RouterLink, CommonModule, FooterComponent, CommonModule, RouterLink, CommonModule, CardModelComponent, PopupComponent, TopBannerComponent, HeaderComponent],
    templateUrl: './shop-masonry-layout.component.html',
    styleUrl: './shop-masonry-layout.component.scss'
})
export class ShopMasonryLayoutComponent {
