...
@Component({
    ...
    imports: [RouterLink, CommonModule, TopBannerComponent, RouterLink, CommonModule, CommonModule, HeaderComponent, PopupComponent, CardModelComponent, FooterComponent],
    templateUrl: './shop-left-sidebar.component.html',
    styleUrl: './shop-left-sidebar.component.scss'
})
export class ShopLeftSidebarComponent {
